...
python3 _prepro_aistpp_music.py --input_video_dir extra_pop --store_dir data/demo_pop_feat_60fps --sampling_rate 30720
python3 _prepro_aistpp_music.py --input_video_dir extra_pop --store_dir data/demo_pop_feat_7.5fps
